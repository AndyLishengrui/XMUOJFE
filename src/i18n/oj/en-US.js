export const m = {
  ...
  Hint: 'Hint',
  Source: 'Source',
  TestCase_Download_Title: 'Test Data',
  TestCase_Download_Description: 'If you need to debug or verify locally, you can download the test data for this problem:',
  TestCase_Download_Button: 'Download Test Data',
  Status: 'Status',
  ...
  Problem_Search_Title: 'Find Problems Through Tags',
  Problem_Search_Subtitle: 'Search by title first, then narrow the list with difficulty and tags. Turn on study view to scan algorithm tags directly in the table.',
  Problem_Search_Placeholder: 'Search by problem ID, title, or any keyword you remember',
  Tag_Search_Placeholder: 'Search inside the tag list',
  Problem_Search_Summary: 'problems match the current filters',
  Active_Filters: 'Active Filters',
  Current_Tag: 'Selected Tag',
  Clear_Filter: 'Clear',
  Popular_Tags: 'Popular Tags',
  Tag_Search_Result: 'Matching Tags',
  More_Tags: 'More Tags',
  No_Tags_Found: 'No tags matched your search',
  Expand_Tags: 'Show more tags',
  Collapse_Tags: 'Collapse tags',
  Show_Source: 'Show Source',
  Show_Source_Help: 'Display source in the problem table',
  Study_View: 'Show Tags',
  Study_View_Help: 'Display tags in the problem table',
  Search: 'Search',
  On: 'On',
  Off: 'Off',
  High: 'High',
