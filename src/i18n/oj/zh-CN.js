export const m = {
  ...
  Hint: '提示',
  Source: '来源',
  TestCase_Download_Title: '测试数据',
  TestCase_Download_Description: '如果你需要线下排查或自测，可以直接下载这道题的测试数据：',
  TestCase_Download_Button: '下载测试数据',
  Status: '状态',
  Information: '信息',
  Time_Limit: '时间限制',
  Memory_Limit: '内存限制',
  ...
  Where_is_the_input_and_the_output_answer_part_9: '写入标准输出。用户程序不允许读取或写入文件，否则您将收到',
  ...
  Java_specifications_answer_part_3: '也必须是非公共类以避免编译错误使用缓冲 I/O 以避免由于过度刷新而导致超出时间限制',
  ...
  Language: '编程语言',
  Theme: '主题',
  Reset_to_default_code_definition: '重设为默认代码设置',
  Upload_file: '上传文件',
  Monokai: 'Monokai 风格',
  ...
  Keyword: '关键字',
  Problem_List: '问题列表',
  Problem_Search_Title: '带着标签去找题',
  Problem_Search_Subtitle: '先搜题目，再按难度和标签收窄范围；进入学习视图后，可以直接在列表里扫读算法标签。',
  Problem_Search_Placeholder: '搜索题号、标题或你记得的关键词',
  Tag_Search_Placeholder: '在标签里搜索你想筛选的内容',
  Problem_Search_Summary: '道题与当前条件匹配',
  Active_Filters: '当前筛选',
  Current_Tag: '已选标签',
  Clear_Filter: '清除',
  Popular_Tags: '常用标签',
  Tag_Search_Result: '匹配标签',
  More_Tags: '更多标签',
  No_Tags_Found: '没有找到匹配的标签',
  Expand_Tags: '展开更多标签',
  Collapse_Tags: '收起标签',
  Show_Source: '显示来源',
  Show_Source_Help: '在题目列表中显示来源',
  Study_View: '显示标签',
  Study_View_Help: '在题目列表中显示标签',
  Search: '搜索',
  On: '开',
  Off: '关',
  High: '高',
  ...
  Short_Partial_Accepted: '部分对',
  Short_Compile_Error: '编译错',
  Short_Wrong_Answer: '答案错',
  // UserHome.vue
  ...
  // ProfileSetting.vue
  Drop_here_or_click_to_select_manually: '拖放到此处，或单击此处手动选择',
  Your_avatar_will_be_set_to: '您的头像将被设置为',
  Upload: '上传',
  Real_Name: '真实姓名',
  Class_Name: '班级编号',
  Major: '专业',
  ...
  You_will_need_to_login_again_after_5_seconds: '您需要在5秒后再次登录...',
